                            ...
                            <div class="tab-pane" id="profile1">
                               ...
                               <form class="form-horizontal form-border" action="<?php echo base_url();?>mantenimiento/marcas/store" method="POST">
                                    ...
                                    <div class="form-group <?php echo !empty(form_error("nombre"))? 'has-error':'' ?> " >
                                        ...
                                        <div class="col-sm-6">
                                            <input value="<?php echo set_value("nombre")?>" type="text" class="form-control" title="Solo puede contener letras" pattern="[A-Za-z][\s]*{1,50}" placeholder="Nombre de la marca" name="nombre">
