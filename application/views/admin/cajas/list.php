            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="h1">Saldo</h1>
                        <!--<h1 class="h2"><?php echo $caja->Saldo?>-->
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Moviminetos de la caja</h4>
      </div>
                                ...
                                <?php if(!empty($cajas)):?>
                                    <?php foreach($cajas as $caja):?>
                                        <tr>
                                            ...
                                            <td><?php echo $caja->movimiento_id;?></td>
                                            <td><?php echo $caja->total;?></td>
                                            <td><?php echo $caja->saldo;?></td>
                                            <?php $datacaja = $caja->id."*".$caja->movimiento_id."*".$caja->total."*".$caja->fecha."*".$caja->saldo;?>
                                            <td>
                                                <div class="btn-group">
